...
export default function ContentDetailsPage({ params }: { params: Promise<{ id: string }> }) {
  ...
  return <>
    ...
    {generated && <section className="card detail-block" style={{ marginBottom: 18 }}><div className="detail-label"><Icon name="sparkles" size={15} />Conteúdo gerado · versão {generated.version}</div><h3>Legenda</h3><p className="detail-value" style={{ whiteSpace: 'pre-wrap' }}>{generated.caption}</p><h3>Chamada para ação</h3><p className="detail-value">{generated.callToAction}</p><h3>Hashtags</h3><p className="detail-value">{generated.hashtags.join(' ')}</p><small>Gerado em {formatDate(generated.createdAt)}</small></section>}
